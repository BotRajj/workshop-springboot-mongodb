package com.cursonelioalves.workshopmongo.config;
...
import com.cursonelioalves.workshopmongo.dto.AuthorDTO;
import com.cursonelioalves.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, 
				sdf.parse("21/03/20218"), 
				"Partiu viagem", 
				"Vou viajar para São Paulo. Abraço!", 
				new AuthorDTO(
				maria));
